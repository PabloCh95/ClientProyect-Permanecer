...
export function signUpApi(data){
    ...
    const url = "http://192.168.0.11:4000/api/users/sign-up";//recorda siempre modificar el ip , a donde lo desplegue...
    const params = {
        method:"POST",
...
export function loginApi(data){
    ...
    const url = "http://192.168.0.11:4000/api/users/login";
